...
public class FriendSuggestion {
  ...
  public static long computeDistance(Vertex [] graph, Vertex [] reverseGraph, int s, int t,int queryId){
	...
	for(int i=0;i<graph.length;i++){
		...
		//System.out.println("vertex1: " + vertex1 + ", dist: " + graph[vertex1].dist);
		...
		//System.out.println("revVertex: " + revVertex + ", dist: " + reverseGraph[revVertex].dist);
  ...
  private static long shortestPath(Vertex [] graph, Vertex [] reverseGraph, ArrayList<Integer> forgraphprocessedVertices, ArrayList<Integer> revgraphprocessedVertices,int queryId){
	  ...
	  System.out.println("forgraphprocessedVertices: " + forgraphprocessedVertices);
	  System.out.println("revgraphprocessedVertices: " + revgraphprocessedVertices);
	  
	  ArrayList<Integer>		intersect = new ArrayList<Integer>(forgraphprocessedVertices);
	  intersect.retainAll(revgraphprocessedVertices);
